...
export const metadata: Metadata = {
  title: "The AIMS agent — WhatsApp & Telegram",
  ...
  return (
    <>
      ...
      <main>
        <section className="wrap hero">
          <div className="hero-grid">
            <div className="hero-copy">
              ...
              <p className="hero-body">A staff-facing agent on WhatsApp and Telegram, wired into every module you've switched on. It looks things up freely, drafts anything, and only commits — send, post, pay — after you tap Confirm. With your permissions, under your name.</p>
        ...
        <StatsStrip stats={[{ value: "27", label: "actions the agent can take, permission-checked per user" }, { value: "4", label: "of them require a tapped Confirm" }, { value: "30 min", label: "before an unconfirmed action expires" }]} />
        <Agent />
        <section className="wrap section tools-section">
          <div className="section-head">
            <span className="eyebrow">What it can do</span>
            <h2 className="h2">Every tool is a real AIMS action, filtered by what you're allowed to do.</h2>
            <p className="lede">The agent only sees the tools your role permits — and re-checks on every call. The model can't invent a permission.</p>
          </div>
