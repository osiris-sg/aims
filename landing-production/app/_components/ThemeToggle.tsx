...
const KEY = "aims-theme";

/** Sun/moon switch. Persists to localStorage; the inline script in layout.tsx
 *  applies the saved choice before first paint so there is no flash. */
