...
class BankFeedsApi {
     ...
     */
    createFeedConnections(xeroTenantId_1, feedConnections_1, idempotencyKey_1) {
        return __awaiter(this, arguments, void 0, function* (xeroTenantId, feedConnections, idempotencyKey, options = { headers: {} }) {
     ...
     * @param idempotencyKey This allows you to safely retry requests without the risk of duplicate processing. 128 character max.
     */
    createStatements(xeroTenantId_1, statements_1, idempotencyKey_1) {
        return __awaiter(this, arguments, void 0, function* (xeroTenantId, statements, idempotencyKey, options = { headers: {} }) {
     ...
     * @param idempotencyKey This allows you to safely retry requests without the risk of duplicate processing. 128 character max.
     */
    deleteFeedConnections(xeroTenantId_1, feedConnections_1, idempotencyKey_1) {
        return __awaiter(this, arguments, void 0, function* (xeroTenantId, feedConnections, idempotencyKey, options = { headers: {} }) {
     ...
     */
    getFeedConnection(xeroTenantId_1, id_1) {
     ...
     */
    getFeedConnections(xeroTenantId_1, page_1, pageSize_1) {
     ...
     */
    getStatement(xeroTenantId_1, statementId_1) {
        return __awaiter(this, arguments, void 0, function* (xeroTenantId, statementId, options = { headers: {} }) {
     ...
     * @param xeroUserId
     */
    getStatements(xeroTenantId_1, page_1, pageSize_1, xeroApplicationId_1, xeroUserId_1) {
        return __awaiter(this, arguments, void 0, function* (xeroTenantId, page, pageSize, xeroApplicationId, xeroUserId, options = { headers: {} }) {
            const localVarPath = this.basePath + '/Statements';
            let localVarQueryParameters = {};
            let localVarHeaderParams = Object.assign({}, this.defaultHeaders);
            let localVarFormParams = {};
