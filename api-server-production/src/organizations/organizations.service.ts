...
export class OrganizationsService {
  ...
  async update(
    id: string,
    data: { name?: string; address?: string; phoneNumber?: string; registrationNumber?: string; logo?: string | null; defaultStamp?: string | null; customDocumentTypes?: Record<string, string>; taxRate?: number; taxApplicable?: boolean; absorbTax?: boolean; defaultCurrency?: string; bankDetails?: Record<string, string> },
  ) {
    return this.prisma.organization.update({
      where: { id },
      data,
