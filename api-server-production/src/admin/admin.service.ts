...
export class AdminService {
  ...
  async initializeDefaultModules(organizationId: string) {
    const defaultModules = [
      ...
      { moduleCode: 'INVENTORY', displayName: 'Inventory', icon: 'Inventory', sortOrder: 20, config: { route: '/portal/inventory', subMenus: [
      ...
      { moduleCode: 'SALES', displayName: 'Sales', icon: 'ShoppingCart', sortOrder: 25, config: { route: '/portal/sales', subMenus: [
