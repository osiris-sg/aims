 ...
 *
 * KEEP IN SYNC with api-server-production/src/common/utils/normalize-project-name.ts
 * and api-server-production/scripts/merge-duplicate-projects.ts. Any change to
