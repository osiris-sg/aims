...
// The rich Cappitech Orders flow. Formerly the default export in ./page; now
// selected by OrderDetailRouter (in ./page) when enableCappitechOrders is on.
// Logic unchanged — this file is a pure extraction.
export function CappitechOrderDetail({ params }: { params: { id: string } }) {
