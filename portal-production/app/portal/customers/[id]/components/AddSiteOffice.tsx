...
export default function AddSiteOffice({ open, onClose, siteOffice }: AddSiteOfficeProps) {
  ...
  return (
    <Drawer anchor="right" open={open} onClose={handleClose} sx={{ "& .MuiDrawer-paper": { width: { xs: "100%", sm: 400 }, backgroundColor: "background.paper", backgroundImage: "none", borderLeft: 1, borderColor: "divider" } }}>
