...
import DebtorStatementReportInner from "./DebtorStatementReport";
import AuditTrailReportInner from "./AuditTrailReport";
import ReceiptListingReportInner from "./ReceiptListingReport";
import SummaryAgeingReportInner from "./SummaryAgeingReport";
import DetailedAgeingReportInner from "./DetailedAgeingReport";
import DebtorListingReportInner from "./DebtorListingReport";
import HistoricalListingReportInner from "./HistoricalListingReport";
import JvListingReportInner from "./JvListingReport";
import PvListingReportInner from "./PvListingReport";
...
export const DebtorStatement = () => <DebtorStatementReportInner />;
export const AuditTrail = () => <AuditTrailReportInner />;
export const ReceiptListing = () => <ReceiptListingReportInner />;
export const SummaryAgeing = () => <SummaryAgeingReportInner />;
export const DetailedAgeing = () => <DetailedAgeingReportInner />;
export const DebtorListing = () => <DebtorListingReportInner />;
export const HistoricalListing = () => <HistoricalListingReportInner />;
export const JvListing = () => <JvListingReportInner />;
export const PvListing = () => <PvListingReportInner />;
