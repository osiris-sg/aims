...
interface ExtractQuotationToSODialogProps {
  open: boolean;
  onClose: () => void;
...
export default function ExtractQuotationToSODialog({
  ...
  const filteredQuotations = useMemo(() => {
    ...
    // If a customer is already selected in SO, auto-filter to that customer's quotations
    ...
    >
      ...
      >
        <Typography variant="h6" fontWeight={500}>
          Extract Quotation to Sales Order
        </Typography>
