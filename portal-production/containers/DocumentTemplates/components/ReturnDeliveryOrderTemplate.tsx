                  ...
                  <Grid2 container spacing={4}>
                    <Grid2 size={6}>
                      <Grid2 container spacing={4}>
                        ...
                        <Grid2 size={12}>{watch("collectFrom") && <FormInputBox control={control} name="collectFrom" label="Collect From" placeHolder="Enter Collection Location" size="small" labelArriangment={isViewMode ? "horizontal" : "vertical"} viewMode={isViewMode} />}</Grid2>
                      </Grid2>
                    </Grid2>
                    <Grid2 size={6}>
                      <Box sx={{ display: "flex", flexDirection: "column", gap: "var(--half-gap)" }}>
