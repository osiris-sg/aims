...
import useQO2TemplateTableHeader from "../hooks/useQO2TemplateTableHeader";
import SignatureDialog from "./SignatureDialog";
import useGetDocument from "../hooks/useGetDocument";
import DocumentSkeleton from "./DocumentSkeleton";
import usePrintDocumentHandler from "../hooks/usePrintDocumentHandler";
import { useParams } from "next/navigation";
import useQO2DocumentCreator from "../hooks/useQO2DocumentCreator";
import useQO2TemplateHandler from "../hooks/useQO2TemplateHandler";
...
export default function Quotation2Template(props: Props) {
  ...
  const { columns } = useQO2TemplateTableHeader({ viewMode: isViewMode, remove: remove, control, setValue });
