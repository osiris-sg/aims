...
function CleanDocumentPreviewInner({ documentType, data, organization, maintenanceReports, publicShareToken, onSignRequest }: CleanDocumentPreviewProps) {
    ...
    return (
      ...
      >
        ...
        <Box sx={{ display: "flex", mb: 4 }}>
          ...
          <Box sx={{ width: "35%" }}>
            ...
            <Box>
              ...
              <Typography sx={{ fontSize: "0.8125rem", mb: 0.3, whiteSpace: "pre-line" }}>
                {data.customer?.address || data.customerAddress || ""}
              </Typography>
              {(data.deliveryAddress?.attention || data.attention?.name) && (
                <Typography sx={{ fontSize: "0.8125rem", mb: 0.3 }}>
          ...
          <Box sx={{ width: "20%" }}>
            ...
            <Box sx={{ mb: 1.5 }}>
              ...
              <Typography sx={{ fontSize: "0.8125rem", fontWeight: 500, whiteSpace: "pre-line" }}>
            ...
            <TableBody>
              {items.map((item: any, index: number) => (
                <TableRow key={index}>
                        ...
                        <Box sx={{ pl: 1 }}>
                          {typeof item.details === 'string'
                            ? item.details.split("\n").map((detail: string, idx: number) => (
                                <Typography key={idx} sx={{ fontSize: "0.8125rem", color: "#666", lineHeight: 1.4 }}>
                                  {detail}
                                </Typography>
                              ))
                            : <Typography sx={{ fontSize: "0.8125rem", color: "#666", lineHeight: 1.4 }}>
                                {item.details}
                              </Typography>}
                        </Box>
                      )}
                  ...
                  <TableCell sx={{ textAlign: "right" }}>{item.unitPrice === "" || item.unitPrice == null || !Number.isFinite(Number(item.unitPrice)) ? "" : Number(item.unitPrice).toFixed(2)}</TableCell>
                  <TableCell sx={{ textAlign: "right" }}>{item.amount == null || item.amount === "" ? "" : Number(item.amount).toFixed(2)}</TableCell>
                </TableRow>
              ))}
        ...
        {(data.documentInfo?.doNo || data.documentInfo?.qinRef || data.documentInfo?.woNo ||
          ...
          <Box sx={{ mb: 3, fontSize: "0.8125rem", lineHeight: 1.8 }}>
            {data.documentInfo?.doNo && (
        ...
        <Box sx={{ display: "flex", justifyContent: "flex-end", mt: 4 }}>
          <Box sx={{ width: 350 }}>
            ...
            >
              <Typography sx={{ fontSize: "0.8125rem", textAlign: "right", width: "60%" }}>
                Subtotal
              </Typography>
              <Typography sx={{ fontSize: "0.8125rem", textAlign: "right", width: "40%" }}>
                {subtotal.toFixed(2)}
              </Typography>
            </Box>
            ...
            >
              ...
              <Typography sx={{ fontSize: "0.8125rem", textAlign: "right", width: "40%", alignSelf: "flex-end" }}>
                {totalTax.toFixed(2)}
              </Typography>
            </Box>
            ...
            >
              <Typography sx={{ fontSize: "0.8125rem", fontWeight: 600, textAlign: "right", width: "60%" }}>
                TOTAL SGD
              </Typography>
              <Typography sx={{ fontSize: "0.8125rem", fontWeight: 600, textAlign: "right", width: "40%" }}>
                {total.toFixed(2)}
              </Typography>
            </Box>
          </Box>
        ...
        <Box sx={{ mt: 4, pt: 2, textAlign: "center" }}>
          <Typography sx={{ fontSize: "0.8125rem", fontStyle: "italic", color: "#666" }}>
        ...
        <Box sx={{ display: "flex", justifyContent: "flex-end", mb: 3 }}>
          <Box sx={{ width: "250px" }}>
            <Box sx={{ display: "flex", justifyContent: "space-between", mb: 0.5 }}>
              ...
              <Typography sx={{ fontSize: "0.8125rem" }}>{subtotal.toFixed(2)}</Typography>
            </Box>
            {(data.documentInfo?.discountPercent || data.documentInfo?.discount) > 0 && (
              <Box sx={{ display: "flex", justifyContent: "space-between", mb: 0.5 }}>
                <Typography sx={{ fontSize: "0.8125rem" }}>Discount:</Typography>
                <Typography sx={{ fontSize: "0.8125rem" }}>-{(data.documentInfo?.discount || 0).toFixed(2)}</Typography>
              </Box>
            )}
            {totalTax > 0 && (
              <Box sx={{ display: "flex", justifyContent: "space-between", mb: 0.5 }}>
                <Typography sx={{ fontSize: "0.8125rem" }}>GST ({data.documentInfo?.gstPercent || 9}%):</Typography>
                <Typography sx={{ fontSize: "0.8125rem" }}>{totalTax.toFixed(2)}</Typography>
              </Box>
            )}
            <Box sx={{ display: "flex", justifyContent: "space-between", borderTop: "1px solid #000", pt: 0.5 }}>
              <Typography sx={{ fontSize: "0.8125rem", fontWeight: 600 }}>Total {data.documentInfo?.currency || "SGD"}:</Typography>
              <Typography sx={{ fontSize: "0.8125rem", fontWeight: 600 }}>{(total - (data.documentInfo?.discount || 0)).toFixed(2)}</Typography>
            </Box>
          </Box>
        </Box>
        ...
        <Box sx={{ mt: "auto", pt: 4 }}>
          <Box sx={{ display: "flex", justifyContent: "space-between" }}>
            <Box sx={{ width: "45%", pageBreakInside: "avoid", breakInside: "avoid" }}>
              <Typography sx={{ fontSize: "0.8125rem", mb: 0.5 }}>Remarks:</Typography>
              <Typography sx={{ fontSize: "0.8125rem", whiteSpace: "pre-line" }}>{data.remarks || ""}</Typography>
            </Box>
            <Box sx={{ width: "45%", textAlign: "center" }}>
              <Box sx={{ borderBottom: "1px solid #000", mb: 0.5, height: 60 }}></Box>
              <Typography sx={{ fontSize: "0.8125rem" }}>Authorized Signature</Typography>
            </Box>
          </Box>
        </Box>
      </Paper>
  ...
  if (documentType === "TI2" || documentType === "INVOICE" || documentType === "JPSG_DISPOSAL" || documentType === "JPSG_CONSOLIDATED") {
    ...
    // --- JPSG CONSOLIDATED (postpaid weekly) invoice ------------------------
    // One invoice per billing period: material-summary lines + a Daily
    // Breakdown appendix (config.consolidated.dailyBreakdowns). Triggered by
    // the JPSG_CONSOLIDATED template variant / its qtyTonnes column.
    const isJpsgConsolidated =
      documentType === "JPSG_CONSOLIDATED" ||
      (Array.isArray((data as any)?.tableColumnOrder) &&
        (data as any).tableColumnOrder.includes("qtyTonnes"));
    if (isJpsgConsolidated) {
      const round2 = (n: number) => Math.round(n * 100) / 100;
      const cons = ((data as any)?.consolidated || {}) as any;
      const breakdowns: any[] = Array.isArray(cons.dailyBreakdowns) ? cons.dailyBreakdowns : [];
      const conSubtotal = round2(items.reduce((a: number, it: any) => a + (Number(it.amount) || 0), 0));
      const conGst = round2(items.reduce((a: number, it: any) => a + (Number(it.taxAmount) || 0), 0));
      const conTotal = round2(conSubtotal + conGst);
      const conGstPercent = data.documentInfo?.gstPercent ?? 9;
      const num = (v: any, dp: number) => (v == null || v === "" ? "" : Number(v).toLocaleString(undefined, { minimumFractionDigits: dp, maximumFractionDigits: dp }));
      const bdRows = breakdowns.flatMap((day: any, di: number) =>
        (Array.isArray(day.items) ? day.items : []).map((it: any, ii: number) => ({
          key: `${di}-${ii}`,
          date: ii === 0 ? day.date || "" : "",
      ...
      const bdTotalTonnes = round2(breakdowns.reduce((a: number, day: any) => a + (Array.isArray(day.items) ? day.items : []).reduce((s: number, it: any) => s + (Number(it.tonnes) || 0), 0), 0));
      const bdTotalLoads = breakdowns.reduce((a: number, day: any) => a + (Array.isArray(day.items) ? day.items : []).reduce((s: number, it: any) => s + (Number(it.loads) || 0), 0), 0);
      const paymentLabel =
        cons.paymentMethod === "airwallex" ? "Airwallex" :
        cons.paymentMethod === "bank_transfer" ? "Bank Transfer" :
        (cons.paymentMethod || "");
      return (
        <Paper
          data-print-paper
        ...
        >
          ...
          <Typography sx={{ fontSize: "0.9375rem", mb: 1 }}>
            Consolidated Invoice for <Box component="span" sx={{ fontWeight: 700 }}>SOIL DISPOSAL</Box>
          </Typography>
            ...
            >
              <TableHead>
                <TableRow>
                  ...
                  <TableCell sx={{ width: "14%", textAlign: "right" }}>Qty (Tonnes)</TableCell>
                  <TableCell sx={{ width: "12%", textAlign: "right" }}>Rate (S$)</TableCell>
                  <TableCell sx={{ width: "14%", textAlign: "right" }}>Subtotal (S$)</TableCell>
                  <TableCell sx={{ width: "12%", textAlign: "right" }}>GST (S$)</TableCell>
                  <TableCell sx={{ width: "14%", textAlign: "right" }}>Amount (S$)</TableCell>
                </TableRow>
              </TableHead>
              <TableBody>
                {items.map((item: any, index: number) => (
                  <TableRow key={index} sx={{ verticalAlign: "top" }}>
                    ...
                    <TableCell sx={{ textAlign: "right" }}>{num(item.taxAmount, 2)}</TableCell>
                    <TableCell sx={{ textAlign: "right" }}>{num(item.grossAmount ?? (Number(item.amount) || 0) + (Number(item.taxAmount) || 0), 2)}</TableCell>
                  </TableRow>
                ))}
              </TableBody>
            </Table>
          ...
          <Box sx={{ display: "flex", justifyContent: "flex-end", mb: 2 }}>
            <Box sx={{ minWidth: 280, borderTop: "1px solid #000", pt: 1 }}>
              <Box sx={{ display: "flex", justifyContent: "space-between", py: 0.3 }}>
                ...
                <Typography sx={{ fontSize: "0.8125rem", fontWeight: 600 }}>{num(conSubtotal, 2)}</Typography>
              </Box>
              <Box sx={{ display: "flex", justifyContent: "space-between", py: 0.3 }}>
                <Typography sx={{ fontSize: "0.8125rem" }}>GST {conGstPercent}% (S$):</Typography>
                <Typography sx={{ fontSize: "0.8125rem" }}>{num(conGst, 2)}</Typography>
              </Box>
              <Box sx={{ display: "flex", justifyContent: "space-between", py: 0.5, borderTop: "1px solid #000", mt: 0.3 }}>
                ...
                <Typography sx={{ fontSize: "0.875rem", fontWeight: 700 }}>{num(conTotal, 2)}</Typography>
              </Box>
            </Box>
          </Box>

          {/* Daily breakdown appendix */}
          {bdRows.length > 0 && (
            <Box sx={{ mb: 2 }}>
              <Typography sx={{ fontSize: "0.875rem", fontWeight: 700, mb: 0.5 }}>Daily Breakdown</Typography>
              <TableContainer>
                <Table
                  size="small"
                  sx={{
                    "& .MuiTableCell-root": { border: "none", padding: "4px 8px", fontSize: "0.78rem" },
                    "& .MuiTableHead-root .MuiTableCell-root": { borderBottom: "1.5px solid #000", fontWeight: 600 },
                    "@media print": { "& thead": { display: "table-row-group" } },
                  }}
                >
                  <TableHead>
                    <TableRow>
                      ...
                      <TableCell sx={{ width: "35%" }}>Material Type</TableCell>
                      <TableCell sx={{ width: "20%", textAlign: "right" }}>Tonnes</TableCell>
                      <TableCell sx={{ width: "20%", textAlign: "right" }}>Loads</TableCell>
                    </TableRow>
                  </TableHead>
                  <TableBody>
                    {bdRows.map((r) => (
                      <TableRow key={r.key}>
                        ...
                        <TableCell sx={{ textAlign: "right" }}>{num(r.tonnes, 3)}</TableCell>
                        <TableCell sx={{ textAlign: "right" }}>{r.loads ?? ""}</TableCell>
                      </TableRow>
                    ))}
                    <TableRow>
                      <TableCell colSpan={2} sx={{ fontWeight: 700, borderTop: "1.5px solid #000" }}>
                        Total{cons.transactionCount ? ` — ${cons.transactionCount} transactions` : ""}
                      </TableCell>
                      <TableCell sx={{ textAlign: "right", fontWeight: 700, borderTop: "1.5px solid #000" }}>{num(bdTotalTonnes, 3)}</TableCell>
                      <TableCell sx={{ textAlign: "right", fontWeight: 700, borderTop: "1.5px solid #000" }}>{bdTotalLoads}</TableCell>
                    </TableRow>
                  </TableBody>
                </Table>
              </TableContainer>
          ...
          {/* Payment method note (postpaid — expected rail) */}
          {paymentLabel && (
            <Box sx={{ border: "1px solid #c8d4e8", backgroundColor: "#eef3fb", borderRadius: 1, p: 1.5, mb: 2 }}>
              <Typography sx={{ fontSize: "0.8125rem", fontWeight: 700, color: "#1f3a5f", mb: 0.3 }}>Payment Method</Typography>
              <Typography sx={{ fontSize: "0.8125rem", color: "#1f3a5f" }}>
                Please make payment via {paymentLabel}.
              </Typography>
            </Box>
          )}
    ...
    return (
      ...
      >
            ...
            <Box sx={{ display: "flex", justifyContent: "space-between", borderTop: "1px solid #000", pt: 1 }}>
              ...
              <Box sx={{ display: "flex", alignItems: "center", gap: 3 }}>
                <Box sx={{ display: "flex", alignItems: "center" }}>
                  <Typography sx={{ fontSize: "0.8125rem" }}>(Rate :</Typography>
                  <Typography sx={{ fontSize: "0.8125rem", ml: 1, minWidth: 60 }}>{rate.toFixed(6)}</Typography>
                </Box>
                <Box sx={{ display: "flex", alignItems: "center" }}>
                  <Typography sx={{ fontSize: "0.8125rem" }}>Sub-total:</Typography>
                ...
                <Box sx={{ display: "flex", alignItems: "center" }}>
                  ...
                  <Typography sx={{ fontSize: "0.8125rem", ml: 1 }}>:</Typography>
                  <Typography sx={{ fontSize: "0.8125rem", ml: 1, minWidth: 40, textAlign: "right" }}>{gstAmount.toFixed(2)})</Typography>
                </Box>
              </Box>
              ...
              <Box sx={{ minWidth: 200 }}>
                ...
                {discountPercent > 0 && (
                  <Box sx={{ display: "flex", justifyContent: "space-between", py: 0.3 }}>
                    ...
                    <Box sx={{ display: "flex", gap: 2 }}>
                      <Typography sx={{ fontSize: "0.8125rem" }}>{discountPercent.toFixed(2)}</Typography>
                      <Typography sx={{ fontSize: "0.8125rem", textAlign: "right", minWidth: 50 }}>{discountAmount.toFixed(2)}</Typography>
                    </Box>
                  </Box>
                )}
                {discountPercent > 0 && (
                ...
                <Box sx={{ display: "flex", justifyContent: "space-between", py: 0.3 }}>
                  <Typography sx={{ fontSize: "0.8125rem" }}>GST</Typography>
                  <Box sx={{ display: "flex", gap: 2 }}>
                    <Typography sx={{ fontSize: "0.8125rem" }}>{gstPercent.toFixed(2)} %</Typography>
                    <Typography sx={{ fontSize: "0.8125rem", textAlign: "right", minWidth: 50 }}>{gstAmount.toFixed(2)}</Typography>
                  </Box>
                </Box>
        ...
        <Box sx={{ display: "flex", justifyContent: "space-between", gap: 2 }}>
          ...
          <Box sx={{ textAlign: "right" }}>
            <Typography sx={{ fontSize: "0.8125rem", fontStyle: "italic" }}>
    ...
    return (
      ...
      >
        ...
        {(data.documentInfo?.reason || data.remarks) && (
          <Box sx={{ mb: 2, fontSize: "0.8125rem" }}>
              ...
              <>
                ...
                <Box sx={{ display: "flex", justifyContent: "space-between", mt: 4, gap: 2 }}>
                  <Box sx={{ flex: 1, textAlign: "center" }}>
                    <Typography sx={{ fontSize: "0.8125rem", mb: 0.5 }}>PREPARE BY :</Typography>
                    <Box sx={{ borderBottom: "1px solid #000", mb: 0.5, minHeight: 40 }} />
                    <Typography sx={{ fontSize: "0.8125rem", fontWeight: 600 }}>PURCHASER</Typography>
                  </Box>
                  <Box sx={{ flex: 1, textAlign: "center" }}>
                    <Typography sx={{ fontSize: "0.8125rem", mb: 0.5 }}>CHECKED BY</Typography>
                    <Box sx={{ borderBottom: "1px solid #000", mb: 0.5, minHeight: 40 }} />
                    <Typography sx={{ fontSize: "0.8125rem", fontWeight: 600 }}>SENIOR PURCHASER</Typography>
                  </Box>
                  <Box sx={{ flex: 1, textAlign: "center" }}>
                    <Typography sx={{ fontSize: "0.8125rem", mb: 0.5 }}>APPROVED BY</Typography>
                    <Box sx={{ borderBottom: "1px solid #000", mb: 0.5, minHeight: 40 }} />
                    <Typography sx={{ fontSize: "0.8125rem", fontWeight: 600 }}>SENIOR OPERATIONAL MANAGER</Typography>
                  </Box>
                  <Box sx={{ flex: 1, textAlign: "center" }}>
                    <Typography sx={{ fontSize: "0.8125rem", mb: 0.5 }}>ACKNOWLEDGE BY :</Typography>
                    <Box sx={{ borderBottom: "1px solid #000", mb: 0.5, minHeight: 40 }} />
                    <Typography sx={{ fontSize: "0.8125rem", fontWeight: 600 }}>VENDOR</Typography>
                  </Box>
                </Box>
              ...
              if (rawConfigColumns && rawConfigColumns.length > 0) {
                ...
                const valueFor = (col: string, item: any, index: number) => {
                  switch (col) {
                    ...
                    case "amount": return item.amount === "" || item.amount == null ? "" : (Number(item.amount) || 0).toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 });
                ...
                <TableBody>
                  {items.map((item: any, index: number) => (
                    <TableRow key={index} sx={{ verticalAlign: "top" }}>
                      ...
                      <TableCell sx={{ textAlign: "right", verticalAlign: "top" }}>{item.unitPrice === "" || item.unitPrice == null || !Number.isFinite(Number(item.unitPrice)) ? "" : Number(item.unitPrice).toFixed(2)}</TableCell>
                      <TableCell sx={{ textAlign: "right", verticalAlign: "top" }}>{item.amount === "" || item.amount == null ? "" : (Number(item.amount) || 0).toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</TableCell>
                    </TableRow>
                  ))}
  ...
  return (
    ...
    >
          ...
          <TableBody>
            {items.map((item: any, index: number) => (
              <TableRow key={index}>
                ...
                <TableCell align="right">{item.unitPrice === "" || item.unitPrice == null || !Number.isFinite(Number(item.unitPrice)) ? "" : Number(item.unitPrice).toFixed(2)}</TableCell>
                <TableCell align="right">{item.amount == null || item.amount === "" ? "" : Number(item.amount).toFixed(2)}</TableCell>
              </TableRow>
            ))}
      ...
      <Box sx={{ display: "flex", justifyContent: "flex-end", mb: 3 }}>
        <Box sx={{ width: 250 }}>
          ...
          <Box sx={{ display: "flex", justifyContent: "space-between", pt: 1, borderTop: "1px solid #000" }}>
            <Typography variant="body1" sx={{ fontSize: "0.8125rem", fontWeight: "bold" }}>
      ...
      {data.note && (
        <Box sx={{ mb: 2 }}>
          <Typography variant="body2" sx={{ fontSize: "0.8125rem", fontStyle: "italic", fontWeight: 600 }}>
            Notes:
          </Typography>
          <RichContent text={data.note} sx={{ fontSize: "0.8125rem" }} />
        </Box>
      )}
      ...
      {data.termsAndConditions && (
        <Box sx={{ mb: 2, pageBreakInside: "avoid", breakInside: "avoid" }}>
          <Typography variant="body2" sx={{ fontSize: "0.8125rem", fontWeight: 600, mb: 0.5 }}>
            Terms & Conditions:
          </Typography>
          <RichContent text={data.termsAndConditions} sx={{ fontSize: "0.8125rem" }} />
        </Box>
      )}

      {/* Computer Generated Notice */}
      <Box sx={{ position: "absolute", bottom: "15mm", left: "15mm", right: "15mm", textAlign: "center" }}>
        <Typography variant="body2" sx={{ fontSize: "0.8125rem", fontStyle: "italic", color: "#666" }}>
          This is a computer-generated document. No signature is required.
        </Typography>
      </Box>
    </Paper>
