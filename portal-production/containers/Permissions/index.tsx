// /containers/Permissions/index.tsx
"use client";
...
import AddRoleItem from "./components/AddRoleItem";
import { useGetRoles } from "./hooks/useGetRoles";
import useAddRoleStates from "./hooks/useAddRoleStates";
import EditPermissions from "./components/EditPermissions"; // Import the EditPermissions component
...
export default function Permissions() {
  ...
  return (
    <MainCard>
      ...
      {/* Add the EditPermissions component */}
      {selectedRole && (
        <EditPermissions 
