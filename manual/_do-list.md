    ...
    - generic [ref=e129] [box=312,48,1096,820]:
      - generic [ref=e130] [box=312,48,1096,67]:
        - generic [ref=e132] [box=312,50,355,64]:
          - paragraph [ref=e133] [box=312,50,355,36]: Delivery Orders List
          - paragraph [ref=e134] [box=312,90,355,24]: All Delivery Orders for this organization
        - generic [ref=e136] [box=683,48,725,67]:
          - button "Create Delivery Order" [ref=e137] [cursor=pointer] [box=683,48,185,67]:
            - img [ref=e139] [box=697,73,18,18]
            - text: Create Delivery Order
          - button "Upload Delivery Order" [ref=e141] [cursor=pointer] [box=875,48,189,67]:
            - img [ref=e143] [box=890,73,18,18]
            - text: Upload Delivery Order
          - button "Filter" [ref=e145] [cursor=pointer] [box=1073,48,100,67]:
            - generic [ref=e146] [box=1086,61,74,41]:
              - img [ref=e147] [box=1094,71,21,21]
              - text: Filter
          - generic [ref=e151] [box=1181,48,189,37]:
            - img [ref=e153] [box=1195,56,21,21]
            - textbox "Search" [ref=e155] [box=1223,48,146,37]
            - group [box=1181,43,189,42]
      ...
      - generic [ref=e161] [box=296,131,1112,115]:
        - generic [ref=e164] [box=313,148,353,97]:
          - generic [ref=e165] [box=329,164,321,28]:
            - generic [ref=e166] [box=329,168,162,20]: TOTAL DELIVERY ORDERS
      ...
      - table [ref=e191] [box=313,303,1094,74]:
        - rowgroup [ref=e192] [box=313,303,1094,74]:
          - 'row "Delivery Order # Customer Item Status Created Action" [ref=e193] [box=313,303,1094,74]':
            - columnheader [ref=e194] [box=313,303,48,74]:
              - button [ref=e195] [cursor=pointer] [box=337,330,47,21]:
                - generic [ref=e196] [box=337,330,21,21]:
                  - checkbox [ref=e197] [box=337,330,21,21]
                  - img [ref=e198] [box=337,330,21,21]
                - img [ref=e200] [box=362,331,18,18]
            - 'columnheader "Delivery Order #" [ref=e202] [box=361,303,174,74]':
              - 'button "Delivery Order #" [ref=e203] [cursor=pointer] [box=385,319,126,41]':
                - text: "Delivery Order #"
                - img [ref=e204] [box=489,331,18,18]
            - columnheader "Customer" [ref=e206] [box=535,303,174,74]:
              - button "Customer" [ref=e207] [cursor=pointer] [box=559,330,93,21]:
                - text: Customer
                - img [ref=e208] [box=630,331,18,18]
            - columnheader "Item" [ref=e210] [box=710,303,174,74]:
              - button "Item" [ref=e211] [cursor=pointer] [box=734,330,56,21]:
                - text: Item
                - img [ref=e212] [box=767,331,18,18]
            - columnheader "Status" [ref=e214] [box=884,303,174,74]:
              - button "Status" [ref=e215] [cursor=pointer] [box=908,330,73,21]:
                - text: Status
                - img [ref=e216] [box=959,331,18,18]
            - columnheader "Created" [ref=e218] [box=1058,303,174,74]:
              - button "Created" [ref=e219] [cursor=pointer] [box=1082,330,81,21]:
                - text: Created
                - img [ref=e220] [box=1142,331,18,18]
            - columnheader "Action" [ref=e222] [box=1233,303,174,74]:
              - button "Action" [ref=e223] [cursor=pointer] [box=1257,330,72,21]:
                - text: Action
                - img [ref=e224] [box=1307,331,18,18]
